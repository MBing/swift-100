...
class ViewController: UIViewController {
    ...
    @objc func showScore() {
        let ac = UIAlertController(title: "Score", message: "Your total score is: \(score)", preferredStyle: .alert)
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        if totalQuestions == 3 {
            ac = UIAlertController(title: "END OF GAME", message: "Your FINAL SCORE is \(score)", preferredStyle: .alert)
